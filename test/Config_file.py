...
process.source = cms.Source("PoolSource", fileNames =
        ...
        cms.untracked.vstring('file:/eos/user/b/bjoshi/EGM/2c1a8864-bc25-4b39-9601-b2d6250652b4.root') #data BParking
        #cms.untracked.vstring("/store/relval/CMSSW_12_4_11/EGamma/MINIAOD/124X_dataRun3_Prompt_v4_gtval_v1_RelVal_2022D-v1/2590000/16cb32c1-4b9f-462b-a599-01c926fadaab.root"),
...
valueMapTags = {
        "eleVeto": cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-veto"),
        "eleLoose": cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-loose"),
        "eleMedium": cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-medium"),
        "eleTight": cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-tight"),
        ...
        "eleNoIsoWp90": cms.InputTag("egmGsfElectronIDs:mvaEleID-RunIIIWinter22-noIso-V1-wp90")
        }
...
process.electrons = cms.EDAnalyzer('ElectronAnalyzer',
        ...
        PV_Src = cms.untracked.InputTag("offlineSlimmedPrimaryVertices"),
        SV_Src = cms.untracked.InputTag("slimmedSecondaryVertices"),
        eleVeto =  valueMapTags["eleVeto"],
        eleMedium = valueMapTags["eleMedium"],
        eleTight = valueMapTags["eleTight"],
        eleLoose = valueMapTags["eleLoose"],
        eleIsoWp80 = valueMapTags["eleIsoWp80"],
        eleIsoWp90 = valueMapTags["eleIsoWp90"],
        eleNoIsoWp80 = valueMapTags["eleNoIsoWp80"],
        eleNoIsoWp90 = valueMapTags["eleNoIsoWp90"]) # untracked.

process.load("RecoEgamma.ElectronIdentification.egmGsfElectronIDs_cfi")
process.load("RecoEgamma.ElectronIdentification.ElectronMVAValueMapProducer_cfi")
process.egmGsfElectronIDs.physicsObjectSrc = cms.InputTag("slimmedElectrons")
process.electronMVAValueMapProducer.src  = cms.InputTag("slimmedElectrons")
process.egmGsfElectronIDSequence = cms.Sequence(process.egmGsfElectronIDs)
process.egmMVAIDSequence = cms.Sequence(process.electronMVAValueMapProducer)
...
process.p = cms.Path(process.egmMVAIDSequence*process.egmGsfElectronIDSequence*process.electrons)
