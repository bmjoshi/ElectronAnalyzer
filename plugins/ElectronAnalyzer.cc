// -*- C++ -*-
//
// Package:    EGM/ElectronAnalyzer
// Class:      ElectronAnalyzer
//
/**\class ElectronAnalyzer ElectronAnalyzer.cc EGM/ElectronAnalyzer/plugins/ElectronAnalyzer.cc
...
//         Created:  Tue, 08 Aug 2023 11:46:37 GMT
//
//
...
ElectronAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   {
      const auto ele = electrons->at(numele);
      ...
      if(it->isPF())
      {
         ...
         cout<<"Printing Id decisions"<<endl;
         ...
         cout<<(*tight_id_decisions)[electronRef]<<" "
            <<(*loose_id_decisions)[electronRef]<<endl;
         ...
         //vaEleID_Winter22_noIso_V1_wp90.push_back((*wp80_noiso_id_decisions)[electronRef]);
